...
func newNotification(db *gorm.DB, opts ...gen.DOOption) notification {
	...
	_notification.Category = field.NewString(tableName, "category")
	_notification.Severity = field.NewString(tableName, "severity")
	_notification.Subject = field.NewString(tableName, "subject")
	_notification.Origin = field.NewString(tableName, "origin")
...
func (n *notification) updateTableName(table string) *notification {
	...
	n.Severity = field.NewString(table, "severity")
	n.Subject = field.NewString(table, "subject")
	n.Origin = field.NewString(table, "origin")
...
func (n *notification) fillFieldMap() {
	...
	n.fieldMap["severity"] = n.Severity
